...
public interface ErrorMessage {
    ...
    String INVALID_ACCOUNT_NUMBER = "Invalid account number.It must be exactly 16 digits and contain only numbers";
    String DAILY_LIMIT = "Withdrawal failed : amount exceed daily limit of $";
